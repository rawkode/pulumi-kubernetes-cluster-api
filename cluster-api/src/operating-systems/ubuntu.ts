...
abstract class Ubuntu extends OperatingSystem {
  name(): string {
    return "Ubuntu";
  }
...
export class Ubuntu2004 extends Ubuntu implements OperatingSystem {
  version(): string {
    return "20.04";
  }
}

export class Ubuntu2010 extends Ubuntu implements OperatingSystem {
  version(): string {
    return "20.10";
  }
}
